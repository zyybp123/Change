 ...
 * <pre>
 *     author : xiaweizi
 *     class  : com.xiaweizi.cornerslibrary.MyRoundCorners
...
public class MyRoundCorners implements Transformation<Bitmap> {
    private static final String ID = "cn.bpzzr.change.util.image.MyRoundCorners";
    ...
    public MyRoundCorners(Context context, int radius, CornerType type) {
    ...
    public boolean equals(Object o) {
        if (o instanceof MyRoundCorners) {
            MyRoundCorners other = (MyRoundCorners) o;
