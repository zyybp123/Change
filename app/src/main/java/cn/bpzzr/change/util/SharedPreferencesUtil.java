...
public class SharedPreferencesUtil {
    ...
    private SharedPreferencesUtil(String fileName) {
        ...
        if (mSharedPreferences == null) {
            ...
            mSharedPreferences = Change.mContext.getSharedPreferences(fileName, Context.MODE_PRIVATE);
     ...
     * @return 返回唯一实例
     */
    public static SharedPreferencesUtil getInstance(String fileName) {
        if (mInstance == null) {
            synchronized (SharedPreferencesUtil.class) {
                if (mInstance == null) {
                    mInstance = new SharedPreferencesUtil(fileName);
                }
            }
        }
        return mInstance;
