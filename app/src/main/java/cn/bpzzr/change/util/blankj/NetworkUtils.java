...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        Change.mContext.startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) Change.mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Change.mContext.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Change.mContext.getSystemService(Context.WIFI_SERVICE);
